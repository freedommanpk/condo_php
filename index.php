...
<html>
    <head>
        ...
        <?php include ("_inc/css-js.php"); ?>
        <script src="rs/js/ui/languages.js" type="text/javascript"></script>
        <script src="rs/js/ui/index.js" type="text/javascript"></script>
    </head>
    <body><strong i18n="under_construction">Under Construction</strong>
        <div id="wrap">
            <div id="header">
            ...
            <div id="main">
                <ul id="tabs">
                    <li><a href="news.php" i18n="menu_news" name="#tab1">ข่าว</a></li>
                    <li><a href="buy.php" i18n="menu_buy" name="#tab2">หาซื้อ</a></li>
                    <li><a href="buy.html" i18n="menu_sell" name="#tab3">โพสขาย</a></li>
                    <li><a href="tem.html" i18n="menu_rent" name="#tab4">หาเช่า</a></li> 
                    <li><a href="tem.html" i18n="menu_irent" name="#tab5">ปล่อยเช่า</a></li>
                    <li><a href="tem.html" i18n="menu_maintence" name="#tab6">ดูแล</a></li>
                </ul>
                <div id="content"> 
